...
process.env.GOVUKNOTIFY_NEW_TEMPLATE_ID = "aea2a584-4dca-4970-a90d-93977e752fdf"
...
process.env.SESSION_RETURN_RECORD_TTL_SECS = '950400';
process.env.INITIAL_SESSION_RECORD_TTL_SECS = '43200';
